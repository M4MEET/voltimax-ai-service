...
RULES:
  ...
  - Use "account_info" ONLY when customer asks about their OWN account: login, password, address changes, Kundenkonto, "Mein Konto". NEVER use for "Kundendienst", "wo ist Ihr Support?", company location, contact info, opening hours — those are general questions (action="none", intent=rag_query)
